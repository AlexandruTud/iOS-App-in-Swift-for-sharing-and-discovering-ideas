...
struct Comment: Identifiable, Codable {
    ...
    var showReplyField: Bool
    var replyText: String

    init(id: String, username: String = "", text: String, timestamp: Date, likes: Int, isLiked: Bool, replyToCommentID: String?, showReplyField: Bool, replyText: String) {
        self.id = id
        ...
        self.showReplyField = showReplyField
...
struct LikeButtonStyle: ButtonStyle {
    func makeBody(configuration: Configuration) -> some View {
        configuration.label
            .background(configuration.isPressed ? Color.clear : Color.clear) // Culorile pot fi personalizate
            .cornerRadius(5) // Rotunjirea colțurilor pentru un aspect mai vizual
    }
}
...
/* func resetLikesForComment(comment: Comment) {
    ...
    private func fetchComments() {
        ...
        if let currentUser = currentUser {
            ...
            db.collection("ideas")
                .whereField("category", isEqualTo: "IT")
